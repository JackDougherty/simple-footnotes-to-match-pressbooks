<?php
/*
 * Plugin Name: Simple Footnotes to match PressBooks
 * Plugin URI: http://wordpress.org/extend/plugins/simple-footnotes/
 * Plugin Description: Modified shortcode to match PressBooks format. Create simple, elegant footnotes on your site. Use the <code>[footnote]</code> shortcode ([footnote]My note.[/footnote]) and the plugin takes care of the rest. There's also a <a href="options-reading.php">setting</a> that enables you to move the footnotes below your page links, for those who paginate posts.
 * Version: 0.3.1
 * Author: Andrew Nacin; modified by Jack Dougherty, 16 March 2013
...
class nacin_footnotes {
        ...
        function nacin_footnotes() {
                add_shortcode( 'footnote', array( &$this, 'shortcode' ) );
